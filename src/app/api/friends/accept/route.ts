...
export async function POST(req: Request) {
    try {
        ...
        //finding the user and performing validation
        ...
        //the only people allowed to add are from where you have incoming friend request
        ...
        //adding both of them as friends to each other
